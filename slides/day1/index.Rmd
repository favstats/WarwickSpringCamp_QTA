...
<!-- #### What is <img src="https://raw.githubusercontent.com/favstats/ds3_r_intro/main/images/Rlogo.svg" width="30px" inline-block/> ? -->


.leftcol[

#### Why learn <img src="https://raw.githubusercontent.com/favstats/ds3_r_intro/main/images/Rlogo.svg" style="display: inline-block; margin: 0"; width="30px"/>?
...
+ Introduction `r emo::ji("white_check_mark")`
...
## .fancy[.red[Quantitative]] Text Analysis - SOME EXAMPLES
...
Link to the first Google Colab  (out of two): [tinyurl.com/ds3rintro1](https://colab.research.google.com/drive/1cwaDldUvXMrtT1DT93UhhcdOBqATKM-E?usp=sharing)
...
```{r, echo=F}
read_csv("../day2/data/pos_tags_trump_all.csv") %>%
...
trump_tweets <- readr::read_csv("https://raw.githubusercontent.com/favstats/WarwickSpringCamp_QTA/main/slides/day1/data/trump_tweets.csv")
```
