...
In practice, these approaches can often overlap!
...
data_corpus_guardian <- data_corpus_guardian[["documents"]] %>% 
  rownames_to_column("text_id")

data_corpus_guardian

saveRDS(data_corpus_guardian, "data/data_corpus_guardian.rds")


data_corpus_ukmanifestos <- quanteda.corpora::data_corpus_ukmanifestos[["documents"]] %>% 
  rownames_to_column("text_id")

data_corpus_ukmanifestos <- tidytext::tidy(quanteda.corpora::data_corpus_ukmanifestos)

saveRDS(data_corpus_ukmanifestos, "data/data_corpus_ukmanifestos.rds")
```
...
15   M I N U T E S   B R E A K:   *11:00*
