...
-------------------|------------------
 <img src="https://github.com/jamesmartherus/debates/raw/master/man/figures/logo.png" width = "150"> | <p style="font-size:10px">"`debates` provides easy access to debate transcripts from Presidential, Vice Presidential, and primary candidate debates. The current version includes Presidential and Vice-Presidential debate transcripts starting in 1960, and for most debates from the 2012, 2016, and 2020 primary elections."</p>

Let's figure out topics in debates!
...
The labelled dataset is a collection of data that has been labelled with the desired outcome. The model is then able to use the labelled dataset to learn how to map the input data to the correct output. 
...
Supervised machine learning is also used for sentiment analysis, which is used to automatically detect the sentiment of a text.
...
If we only had training data, we would have no way of knowing how our model would perform on new, unseen data. This could lead to **overfitting**, where our model performs well on training data but poorly on test data. 
...
Hyperparameters are parameters that define the overall structure of a machine learning model. They are used to control the learning process of the model.
...
*What are the risks of tuning hyperparameters?*
